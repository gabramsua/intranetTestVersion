                ...
                switch ($usuario->getLang()) {
                  case 'es':
                      if ($formIncoming['status']==1){
                          ...
                          $mail->Body = "El formulario que mandaste del tipo ".$formIncoming['type']." ha sido aceptado, por favor chequea que es correcto <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>aqui</a>.<br><img class='profile-img' src='../../images/webcuisine-logo.png'>";
                      }else{
                          $mail->Subject = "Su formulario ha sido rechazado.";

                          $mail->Body = "El formulario que mandaste del tipo ".$formIncoming['type']." ha sido rechazado, por favor chequea que es correcto <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>aqui</a>.<br><img class='profile-img' src='../../images/webcuisine-logo.png'>";
                      }
                      break;
                  case 'en':
                      if ($formIncoming['status']==1){
                        $mail->Subject = "Your form has been accepted.";
                        $mail->Body = "You send a ".$formIncoming['type']." form, and it has been accepted please check it <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>here</a>.<br><img class='profile-img' src='../../images/webcuisine-logo.png'>";
                      }else{

                        $mail->Subject = "Your form has been rejected.";
                        $mail->Body = "You send a ".$formIncoming['type']." form, and it has been rejected please check it <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>here</a>.<br><img class='profile-img' src='../../images/webcuisine-logo.png'>";
                      }
                      break;
                  case 'fr':
                      if ($formIncoming['status']==1){
                          $mail->Subject = "Sa forme a été acceptée.";
                          $mail->Body = "La forme que vous avez envoyé le gars ".$formIncoming['type']." a eté accepté, S'il vous plaît vérifier qu'il est <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>ici</a>.<br><img class='profile-img' src='../../images/webcuisine-logo.png'>";
                      }else{
                          $mail->Subject = "Sa forme a été rejetée.";
                          $mail->Body = "La forme que vous avez envoyé le gars ".$formIncoming['type']." a été rejetée, S'il vous plaît vérifier qu'il est <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>ici</a>.<br><img class='profile-img' src='../../images/webcuisine-logo.png'>";
                      }
                      break;
                ...
                if(strcmp($_SESSION['dirs'][$i], $mailo['email']) == 0){
                    ...
                    switch ($mailo['lang']) {
                      case 'es':
                            ...
                            $mail->Body = "El usuario ".$user->getNameU()." ".$user->getSurnameU()." ha enviado un formulario del tipo ".$type.". Por favor, échale un vistazo <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>aqui</a>.";
                          break;
                      case 'en':

                            $mail->Subject = "Somebody send a form to the intranet.";

                            $mail->Body = "The user ".$user->getNameU()." ".$user->getSurnameU()."has just send a ".$type." form, please check it <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>here</a>.";
                          break;
                      case 'fr':

                              $mail->Subject = "Quelqu'en a envoyée a form";

                            $mail->Body = "Le user ".$user->getNameU()." ".$user->getSurnameU()." a envoyée a ".$type." form. S'il vous plaît vérifier qu'il est <a href='http://intranet.stage.unitedcuisines.net/webCuisine/web/app_dev.php/es/index'>ici</a>.";
                          break;
